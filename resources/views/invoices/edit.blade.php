...
<div class="max-w-2xl mx-auto">
    <!-- Page Header -->
    <div class="mb-8">
        <h2 class="text-3xl font-bold text-slate-800">Edit Invoice</h2>
        <p class="text-slate-500 mt-1">Update invoice information</p>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        <form action="{{ route('invoices.update', $invoice) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="invoice_no" name="invoice_no" required class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('invoice_no') border-red-500 @enderror" value="{{ old('invoice_no', $invoice->invoice_no) }}">
            ...
            <div class="mb-4">
                ...
                <select id="patient_id" name="patient_id" required class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('patient_id') border-red-500 @enderror">
                    ...
                    @foreach($patients as $patient)
                        <option value="{{ $patient->id }}" {{ old('patient_id', $invoice->patient_id) == $patient->id ? 'selected' : '' }}>{{ $patient->first_name }} {{ $patient->last_name }}</option>
                    @endforeach
                </select>
            ...
            <div class="mb-4">
                ...
                <select id="admission_id" name="admission_id" class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                    ...
                    @foreach($admissions as $admission)
                        <option value="{{ $admission->id }}" {{ old('admission_id', $invoice->admission_id) == $admission->id ? 'selected' : '' }}>{{ $admission->admission_no }}</option>
                    @endforeach
                </select>
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="date" id="invoice_date" name="invoice_date" required class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('invoice_date') border-red-500 @enderror" value="{{ old('invoice_date', $invoice->invoice_date->format('Y-m-d')) }}">
            ...
            <div class="mb-4">
                ...
                <input type="number" id="subtotal" name="subtotal" required step="0.01" min="0" class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('subtotal') border-red-500 @enderror" value="{{ old('subtotal', $invoice->subtotal) }}">
            ...
            <div class="mb-4">
                ...
                <input type="number" id="discount" name="discount" step="0.01" min="0" class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" value="{{ old('discount', $invoice->discount) }}">
            </div>

            <!-- Tax -->
            <div class="mb-4">
                <label for="tax" class="block text-sm font-medium text-slate-700 mb-2">Tax</label>
                <input type="number" id="tax" name="tax" step="0.01" min="0" class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" value="{{ old('tax', $invoice->tax) }}">
            </div>

            <!-- Net Total -->
            <div class="mb-4">
                <label for="net_total" class="block text-sm font-medium text-slate-700 mb-2">Net Total *</label>
                <input type="number" id="net_total" name="net_total" required step="0.01" min="0" class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('net_total') border-red-500 @enderror" value="{{ old('net_total', $invoice->net_total) }}">
            ...
            <div class="mb-6">
                ...
                <textarea id="notes" name="notes" rows="3" class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('notes', $invoice->notes) }}</textarea>
            </div>
