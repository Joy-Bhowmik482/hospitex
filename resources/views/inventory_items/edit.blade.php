...
<div class="max-w-4xl mx-auto">
    <!-- Page Header -->
    <div class="mb-8">
        <h2 class="text-3xl font-bold text-slate-800 mb-2">Edit Inventory Item</h2>
        <p class="text-slate-600">Update the inventory item information below.</p>
    </div>
    ...
    <div class="bg-white rounded-2xl shadow-lg border border-slate-200 p-8">
        ...
        <form action="{{ route('inventory-items.update', $inventoryItem) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="border-b border-slate-200 pb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="name" name="name" value="{{ old('name', $inventoryItem->name) }}"
                    ...
                    <div>
                        ...
                        <input type="text" id="unit" name="unit" value="{{ old('unit', $inventoryItem->unit) }}"
                    ...
                    <div>
                        ...
                        <input type="number" id="qty_on_hand" name="qty_on_hand" value="{{ old('qty_on_hand', $inventoryItem->qty_on_hand) }}" min="0"
                    ...
                    <div>
                        ...
                        <input type="number" id="reorder_level" name="reorder_level" value="{{ old('reorder_level', $inventoryItem->reorder_level) }}" min="0"
