...
<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white rounded-2xl shadow-lg border border-slate-200 p-8">
        ...
        <form action="{{ route('admissions.update', $admission) }}" method="POST" class="space-y-6" id="admissionForm">
            @csrf
            @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="datetime-local" id="admitted_at" name="admitted_at"
                            value="{{ old('admitted_at', optional($admission->admitted_at)->format('Y-m-d\TH:i')) }}"
                    ...
                    <div>
                        ...
                        <input type="datetime-local" id="discharge_at" name="discharge_at"
                            value="{{ old('discharge_at', optional($admission->discharge_at)->format('Y-m-d\TH:i')) }}"
