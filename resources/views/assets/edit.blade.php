...
<div class="max-w-4xl mx-auto">
    <!-- Page Header -->
    <div class="mb-8">
        <h2 class="text-3xl font-bold text-slate-800 mb-2">Edit Asset</h2>
        <p class="text-slate-600">Update the asset information below.</p>
    </div>
            ...
            <div class="border-b border-slate-200 pb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="asset_code" name="asset_code" value="{{ old('asset_code', $asset->asset_code) }}"
                    ...
                    <div>
                        ...
                        <input type="text" id="category" name="category" value="{{ old('category', $asset->category) }}"
                    ...
                    <div>
                        ...
                        <input type="number" id="cost" name="cost" value="{{ old('cost', $asset->cost) }}" step="0.01" min="0"
