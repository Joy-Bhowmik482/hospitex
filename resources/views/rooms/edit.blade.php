...
<div class="max-w-4xl mx-auto">
    <!-- Page Header -->
    <div class="mb-8">
        <h2 class="text-3xl font-bold text-slate-800 mb-2">Edit Room</h2>
        <p class="text-slate-600">Update the room information below.</p>
    </div>
            ...
            <div class="border-b border-slate-200 pb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select id="ward_id" name="ward_id" 
                            ...
                            @foreach ($wards as $ward)
                                <option value="{{ $ward->id }}" {{ old('ward_id', $room->ward_id) == $ward->id ? 'selected' : '' }}>{{ $ward->name }}</option>
                            @endforeach
                        </select>
                        @error('ward_id')
                    ...
                    <div>
                        ...
                        <input type="text" id="room_no" name="room_no" value="{{ old('room_no', $room->room_no) }}" 
                    ...
                    <div>
                        ...
                        <input type="text" id="room_type" name="room_type" value="{{ old('room_type', $room->room_type) }}" 
                    ...
                    <div>
                        ...
                        <input type="number" id="daily_rate" name="daily_rate" value="{{ old('daily_rate', $room->daily_rate) }}" 
